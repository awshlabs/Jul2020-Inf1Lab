...
## Lab 4 Section 1: Profile the network and collect inference traces on Inf1 instance
...
**4.1.1** Set the environment variable
```
mkdir -p profile
...
**4.1.2** Run inference from Lab 2 through the framework
```
python infer_resnet50.py
```

## Lab 4 Section 2: Visualizing data with TensorBoard-Neuron
...
**4.5.1** Select the “Neuron Profile” plugin
...
>Newest versions of Chrome may have broken this feature. Check back for fixes. (noted 5/21/2020)

![image](./images/3.59.37PM.png)

## Lab 4 Section 6: How to debug an inference

**4.6.1** Launch TensorBoard-Neuron and navigate to the webpage
...
**4.6.2** Modify and run your inference script
...
**4.6.3** Select the “debugger” plugin
